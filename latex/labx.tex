...
\begin{table}[htbp]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{llrrrrrl}
			...
			GET /product/\{id\} - 有效ID1 & \texttt{GET /product/OLJCESPC7Z} & 50 & 0 & 0\% & 35.48\,ms & 200 & 正常用例 \\
			GET /product/\{id\} - 有效ID2 & \texttt{GET /product/LS4PSXUNUM} & 50 & 0 & 0\% & 24.80\,ms & 200 & 正常用例 \\
			GET /product/\{id\} - 不存在的ID & \texttt{GET /product/NONEXIST99} & 50 & 50 & 100\% & 24.82\,ms & 500 & 边界值 \\
			GET /product/\{id\} - SQL注入ID & \texttt{GET /product/' OR '1'='1} & 50 & 50 & 100\% & 22.16\,ms & 500 & 安全测试 \\
			GET /product/\{id\} - 超长ID & \texttt{GET /product/\{LONG\_STR\}} & 50 & 50 & 100\% & 3.50\,ms & 500 & 边界值 \\
			GET /product/\{id\} - 负数ID & \texttt{GET /product/-1} & 50 & 50 & 100\% & 8.56\,ms & 500 & 边界值 \\
			GET /product/\{id\} - XSS注入ID & \texttt{GET /product/}$<$\texttt{script}$>$\texttt{alert(1)}$<$/\texttt{script}$>$ & 50 & 50 & 100\% & 0\,ms & 500 & 安全测试 \\
			GET /product-meta/\{ids\} - 有效ID & \texttt{GET /product-meta/OLJCESPC7Z} & 50 & 0 & 0\% & 49.02\,ms & 200 & 正常用例 \\
			GET /product-meta/\{ids\} - SQL注入 & \texttt{GET /product-meta/' OR '1'='1} & 50 & 0 & 0\% & 27.36\,ms & 500 & 安全测试 \\
			GET /product-meta/\{ids\} - 空ID & \texttt{GET /product-meta/} & 50 & 50 & 100\% & 46.80\,ms & 500 & 边界值 \\
			GET /product-meta/\{ids\} - XSS注入 & \texttt{GET /product-meta/}$<$\texttt{script}$>$\texttt{alert(1)}$<$/\texttt{script}$>$ & 50 & 50 & 100\% & 0\,ms & 500 & 安全测试 \\
